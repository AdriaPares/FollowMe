...
twitch_prepared = cassandra_session.prepare("insert into twitch_hour (timestamp_name, follower_count) values (?,?)");
twitter_prepared = cassandra_session.prepare("insert into twitter_hour (timestamp_name, follower_count) values (?,?)");
youtube_prepared = cassandra_session.prepare("insert into youtube_hour (timestamp_name, subscriber_count) values (?,?)");
