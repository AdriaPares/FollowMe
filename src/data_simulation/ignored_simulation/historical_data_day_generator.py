...
twitch_prep_spark = cassandra_session.prepare("insert into twitch_day_spark (streamer, timestamp, follower_count) values (?,?,?)");
twitter_prep_spark = cassandra_session.prepare("insert into twitter_day_spark (streamer, timestamp, follower_count) values (?,?,?)");
youtube_prep_spark = cassandra_session.prepare("insert into youtube_day_spark (streamer, timestamp, follower_count) values (?,?,?)");
